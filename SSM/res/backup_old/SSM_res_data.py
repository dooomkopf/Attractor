...
# Cycle-Tops aus attractor.py — Labels sind T0..T3 (intern numerisch).
# T0 = '13-Top — liegt typisch VOR dem ersten Embedding-Vektor (W=1394d)
#                und wird im Manifold-Plot nicht erscheinen.
# T1 = '17-Top, T2 = '21-Top, T3 = '25-Top.
_CYCLE_TOPS = [
