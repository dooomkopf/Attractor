...
Module:
    ...
    attractor_n_ens/attractor_n_ens_plot2.py    — Figure 2: Polar + PC3, Figure 3
...
from attractor_n_ens.attractor_n_ens_plot2   import plot_fig2, plot_fig4
