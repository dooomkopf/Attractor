...
# Neutral Laplace-Fit (grau, hauchfein)
neutral_mask = sample_phases == None
neutral_n = n_samples[neutral_mask]
neutral_n_fit = neutral_n[(neutral_n >= -100) & (neutral_n <= 100)]
...
plt.savefig('delta-n-dist-lin.png', dpi=300, facecolor='#0a0a0a')
plt.show()

print(f"\nSaved: delta-n-dist-lin.png")
